...
const Row = ({
  ...
  return (
    <tr className="text-left border-b border-gray-200 hover:bg-gray-50">
      ...
      <td className="text-[#6B7280] text-left py-4 px-4">
        ...
        <table className="w-full text-left table-auto min-w-[650px]">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="py-3 px-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider min-w-[150px]">
                SUBMITTED
              </th>
              <th className="py-3 px-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider min-w-[200px]">
                ASSIGNED REVIEWER
              ...
              <th className="py-3 px-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider min-w-[100px]">
                ACTIONS
              </th>
            </tr>
          </thead>
