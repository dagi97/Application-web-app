  ...
  return (
    <>
      <div className="relative">
        <div className="relative after:absolute after:inset-0 after:bg-[#1F2937] after:mix-blend-soft-light brightness-75">
          <img
        ...
        <div
          className="absolute top-0 left-0 text-white mt-10 center
                px-10 sm:px-30
                "
        >
          <h2
            className="font-bold text-[50px] tracking-[1.5px]
          ...
          <Link href={"/auth/register"}>
            {" "}
            <button className="py-3 px-8 bg-[#4338CA] rounded-md font-medium text-base">
