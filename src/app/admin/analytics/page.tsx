...
const AnalyticsDashboard = () => {
  ...
  const funnelData = analyticsData ? [
    ...
    { name: 'Under Review', value: analyticsData.application_funnel.pending_review },
    { name: 'Interview', value: analyticsData.application_funnel.in_progress },
  ...
  const sortedMapData = [...mapData].sort((a, b) => (b.value as number) - (a.value as number));
