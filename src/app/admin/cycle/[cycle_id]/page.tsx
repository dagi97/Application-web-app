      ...
      <div className="container mx-auto px-4 py-10 md:py-14 lg:py-[56px] max-w-7xl">
        ...
        <div className="w-full max-w-7xl mx-auto mb-10 md:mb-[40px]">
          <div className="px-4 md:px-8">
            ...
            <p className="text-sm text-paleSky">Update the cycle details below</p>
          </div>
        </div>

        {/* Form Section */}
        <form onSubmit={handleSubmit(onSubmit)} className="bg-white rounded-lg shadow-form p-6 w-full max-w-7xl mx-auto">
          {submitSuccess && (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div className="space-y-1">
              <label htmlFor="name" className="text-sm font-medium text-oxfordBlue">
                Cycle Name *
              </label>
              <input
                id="name"
                ...
                className={`w-full p-2 border ${errors.name ? 'border-red-500' : 'border-mischka'} rounded-md shadow-input text-sm`}
            ...
            {/* Start Date Field */}
            <div className="space-y-1">
              <label htmlFor="start_date" className="text-sm font-medium text-oxfordBlue">
                Start Date *
              </label>
              <input
                id="start_date"
                ...
                className={`w-full p-2 border ${errors.start_date ? 'border-red-500' : 'border-mischka'} rounded-md shadow-input text-sm`}
              />
              {errors.start_date && (
            ...
            {/* End Date Field */}
            <div className="space-y-1">
              <label htmlFor="end_date" className="text-sm font-medium text-oxfordBlue">
                End Date *
              </label>
              <input
                id="end_date"
                ...
                className={`w-full p-2 border ${errors.end_date ? 'border-red-500' : 'border-mischka'} rounded-md shadow-input text-sm`}
              />
              {errors.end_date && (
